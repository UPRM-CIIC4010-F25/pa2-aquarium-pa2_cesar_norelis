...
void ofApp::setup(){
    ...
    myAquarium->addAquariumLevel(std::make_shared<Level_2>(2, 60));
    myAquarium->addAquariumLevel(std::make_shared<Level_3>(3, 120));
    myAquarium->addAquariumLevel(std::make_shared<Level_4>(4, 240));
